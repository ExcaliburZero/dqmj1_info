    ...
    string_tables={
        pathlib.Path("arm9.bin"): (
            ...
            [
                ...
                StringTable("strings_e", 0x0208C7AD, 0x0208C824),
                StringTable("strings_f", 0x0208C9E8, 0x0208D498),
                StringTable("strings_g", 0x0208D6E8, 0x0208E718),
                StringTable("strings_h", 0x0208EA58, 0x0208F9DC),
                StringTable("strings_d", 0x0209072C, 0x02091753),
                StringTable("strings_i", 0x0208FB98, 0x020903C0),
            ],
        ),
    ...
    string_address_tables={
        pathlib.Path("arm9.bin"): (
            ...
            [
                ...
                StringAddressTable("unknown_l", 0x0208C824, 0x0208C9E8),
                StringAddressTable("unknown_m", 0x0208D498, 0x0208D6E8),
                StringAddressTable("unknown_n", 0x0208E71C, 0x0208EA58),
                StringAddressTable("unknown_o", 0x0208F9E0, 0x0208FB98),
                StringAddressTable("unknown_p", 0x020903C4, 0x0209072C),
            ],
        ),
        pathlib.Path("overlay")
        / "overlay_0000.bin": (
